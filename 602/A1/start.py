...
def exercise03():
    ...
    # ------ Place code below here \/ \/ \/ ------
    sentence = "This is Python Assignment."
...
def exercise06():
    ...
    hours_worked = 20
    wage_per_hour = 15
    total_pay = hours_worked * wage_per_hour #product of the two to variable total_pay
...
def exercise07():
    ...
    # ------ Place code below here \/ \/ \/ ------
    wage = 17.0
    print("Type of wage: ", type(wage))
    doubled = wage * 2 
    print ("Double wage: ",doubled)
...
def exercise14():
    ...
    length = 50
    height = 10.2
    area = length * height # product of length and height
    area_type = type(area)
...
def exercise15():
    ...
    speed_mph = 80
    duration = 3
    distance =speed_mph * duration #Speed x Time
