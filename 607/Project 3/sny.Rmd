...
# ###______________________WORKING CODE COMMENTED TO SAVE REDOING process of tdata
# 
# str_split(dtf$data[1],"@[[a-zA-Z]]+ [A-Z]{1}[a-z]{1}[a-z]{1} \\d{2} [0-9]{2}:[0-9]{2}:[0-9]{2} [+][0]{4} [0-9]{4}")
# 
# str_split(dtf$data,"@[\\w]+ [A-Z]{1}[a-z]{1}[a-z]{1} \\d{2} [0-9]{2}:[0-9]{2}:[0-9]{2} [+][0]{4} [0-9]{4}") 
# 
# 
# dtf$DateTime<- str_extract(dtf$data[2],"@[\\w]+ [A-Z]{1}[a-z]{1}[a-z]{1} \\d{2} [0-9]{2}:[0-9]{2}:[0-9]{2} [+][0]{4} [0-9]{4}")
# 
# dtf<- separate(dtf,data,c("TName","Tweet"),"@[\\w]+ [A-Z]{1}[a-z]{1}[a-z]{1} \\d{2} [0-9]{2}:[0-9]{2}:[0-9]{2} [+][0]{4} [0-9]{4}",remove = FALSE)
# 
# dtf$Month <- trimws(str_extract(dtf$DateTime," [A-Z]{1}[a-z]{1}[a-z]{1}"))
#  dtf$weekDay <- str_extract(dtf$DateTime,"[A-Z]{1}[a-z]{1}[a-z]{1}")
#  dtf$year <- str_extract(dtf$DateTime,"[0-9]{4}$")
#  dtf$day <- str_extract(dtf$DateTime,"(?<= [A-Z]{1}[a-z]{1}[a-z]{1}) [0-9]{2}")
# dtf <- mutate(dtf, hash = unlist(lapply(str_extract_all(dtf$Tweet,"#\\S+"), function(X){paste(unlist(X), collapse = ", ")})))
# 
# 
# ###______________________WORKING CODE COMMENTED TO SAVE REDOING process of tdata
...
# # htmltools::HTML(DataLink$fullData[1])
